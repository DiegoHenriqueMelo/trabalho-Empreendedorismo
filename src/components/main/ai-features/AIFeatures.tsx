...
function AIFeatures() {
  return (
    <div id="ai-features" className="flex items-center flex-col lg:flex-row flex-wrap justify-evenly min-h-screen py-8 px-4">
      <div className="text-left max-w-md mb-8 lg:mb-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6">
          <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-4 sm:mb-0 sm:mr-4">
      ...
      <div className="relative">
        <div className="w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl flex items-center justify-center">
